	...
	<div id="wrapper" class="clearfix">
				...
				<div class="container clearfix">
					...
					<nav id="primary-menu">
						...
						<ul>
							...
							<li><a href="index.html"><div>Form</div></a></li>
							<li><a href="index.html"><div>Admin</div></a></li>
						</ul>
					</nav>
		...
		<section id="slider" class="slider-parallax full-screen">
			<div class="slider-parallax-inner">
				...
				<div class="full-screen" style="background: url('images/background-slider.jpg'); background-size: cover;">
					<div class="container clearfix">
						...
						<div class="vertical-middle no-fade">
							<div class="col-md-6 dark fright bottommargin-lg" data-animate="fadeIn">
								<div class="emphasis-title here">
									<h1> <strong>Kenali</strong> Autisme Lebih Dini Dengan Cara Yang Mudah</h1>
								</div>
								<a href="<?php echo base_url();?>home/form" class="button button-light button-xlarge button-rounded nomargin"><i class="icon-pencil"></i>Mulai Survey</a>
							</div>
						</div>
				...
				<div class="container clearfix">
					...
					<div class="col-md-6 nobottommargin">
						...
						<div class="feature-box fbox-effect fbox-center fbox-outline nobottomborder">
							...
							<h3>Form<span class="subtitle">Isi survey berikut untuk mengetahui kondisi anakmu</span></h3>
						</div>
						</a>
					</div>
					...
					<div class="col-md-6 nobottommargin">
						...
						<div class="feature-box fbox-effect fbox-center fbox-outline nobottomborder">
							<div class="fbox-icon">
								<i class="icon-search3 i-alt"></i>
							</div>
							<h3>Info<span class="subtitle">Cari tahu mengenai autisme</span></h3>
						</div>
						</a>
					</div>
