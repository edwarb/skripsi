# Pendeteksi Autis menggunakan Metode LDA (Composer installed)
...
This package installed with the offical [CodeIgniter](https://github.com/bcit-ci/CodeIgniter) (version `3.1.*`) with secure folder structure via Composer.
# Status
Not 100% yet

# Description
* Merupakan metode yang digunakan untuk mendeteksi autis dengan menggunakan perhitungan Linear Discriminant Analysis (LDA)

## Contact
mail.edwarb@gmail.com for further info
